    ...
    def __post_init__(self) -> None:
        ...
        self.steps = [
            ...
            Step("monitor_wakes", "The Monitor Agent notices settlement activity",
                 "Nobody prompted it. Paytm checks every settlement it sends, for every merchant, as it happens.", self._wake),
            ...
            Step("follow_up", "Time passes; the agent keeps working",
                 "New batches arrive, settlement ops is slow, rejections come back. The agent chases and re-presents. Late money is reported, not claimed.", self._follow_up),
            ...
            Step("red_team", "Try to make it file a false correction",
